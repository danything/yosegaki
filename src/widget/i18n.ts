...
const ja = {
	...
	like: "いいね",
	verifying: "確認中…",
	loginWith: (label: string) => `${label} でログイン`,
	searchPlaceholder: "本文・名前・メール・URL で検索",
	loginClosed: "ログインが完了しませんでした",
...
const en: typeof ja = {
	...
	like: "Like",
	verifying: "Verifying…",
	loginWith: (label) => `Sign in with ${label}`,
	searchPlaceholder: "Search body, name, email or URL",
	loginClosed: "Sign-in was not completed",
